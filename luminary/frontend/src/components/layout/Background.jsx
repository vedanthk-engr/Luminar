  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:-1, overflow:"hidden", pointerEvents:"none" }}>
      <div style={{ position:"absolute", inset:0, background:`
        radial-gradient(ellipse 70% 60% at 15% 10%, rgba(98,65,181,0.1) 0%, transparent 65%),
        radial-gradient(ellipse 60% 50% at 88% 80%, rgba(200,148,26,0.08) 0%, transparent 60%),
        radial-gradient(ellipse 50% 45% at 55% 45%, rgba(24,168,154,0.06) 0%, transparent 55%),
        radial-gradient(ellipse 40% 35% at 30% 70%, rgba(192,41,58,0.06) 0%, transparent 55%)` }}/>
